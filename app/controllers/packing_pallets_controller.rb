  ...
  def create
    ...
    respond_to do |format|
      if @packing_pallet.save
        format.html { redirect_to @packing_pallet, notice: 'Packing pallet was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @packing_pallet.update_attributes(params[:packing_pallet])
        format.html { redirect_to @packing_pallet, notice: 'Packing pallet was successfully updated.' }
