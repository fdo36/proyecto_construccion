...
ActiveRecord::Schema.define(:version => 20130516002144) do
  ...
  add_foreign_key "pallets", "containers", :name => "pallets_container_id_fk"
...
ActiveRecord::Schema.define(:version => 20130516040045) do
