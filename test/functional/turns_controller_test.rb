...
class TurnsControllerTest < ActionController::TestCase
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post :create, turn: { end_datetime: @turn.end_datetime, name: @turn.name, start_datetime: @turn.start_datetime, subprocess_id: @turn.subprocess_id }
    end
  ...
  test "should update turn" do
    put :update, id: @turn, turn: { end_datetime: @turn.end_datetime, name: @turn.name, start_datetime: @turn.start_datetime, subprocess_id: @turn.subprocess_id }
    assert_redirected_to turn_path(assigns(:turn))
  end
